  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {collapsible !== "none" && <SidebarRail side={side} />}
        <div
          className={cn(
...
>(({ className, side = "left", ...props }, ref) => {
  ...
  return (
    <div
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-2 transition hover:bg-sidebar-border/50 sm:flex",
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex min-h-svh flex-1 flex-col bg-background overflow-y-auto overflow-x-hidden",
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center justify-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-all duration-200 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-primary data-[active=true]:font-semibold data-[active=true]:text-sidebar-primary-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[state=collapsed]:!size-12 group-data-[state=collapsed]:!p-2 group-data-[state=expanded]:justify-start [&>span:last-child]:truncate [&>svg]:size-5 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
